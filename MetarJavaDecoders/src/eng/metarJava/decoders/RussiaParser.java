 ...
 * @author Marek Vajgl
 */
public class RussiaParser implements Parser {
...
@Override
  public Report parse(String line) {
    ...
    ret.setVisibility(EUParserHelper.decodeVisibility(rl));
    ret.setRunwayVisualRanges(EUParserHelper.decodeRunwayVisualRanges(rl));
    ret.setPhenomenas(GenericParserHelper.decodePhenomenas(rl));
    ret.setClouds(EUParserHelper.decodeClouds(rl));
    ...
    ret.setPressure(EUParserHelper.decodePressureInHpa(rl), PressureUnit.hpa);
