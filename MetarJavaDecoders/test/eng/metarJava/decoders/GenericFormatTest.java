...
public class GenericFormatTest {
  ...
  private static final String LKMT
          = "METAR LKMT 241812Z 02032KT 5000NDV RA +SN BLSNVC SCT060 12/05 Q0996 WS R22 NOSIG";
  ...
  private static final String LKPR
          ...
          + "+TSSQVC FEW012 SCT030CB OVC050TCU 12/05 Q1002 RETSRA RESA WS ALL RWY NOSIG";
  ...
  public void testParseWindshearAll() {
    ...
    assertEquals(0, r.getRunwayWindshears().size());
  ...
  public void testParseWindshear() {
    ...
    Report r = p.parse(LKMT);
        ...
        assertNotNull(r.getRunwayWindshears());
    assertEquals(1, r.getRunwayWindshears().size());
    assertFalse(r.getRunwayWindshears().isAllRunways());
      assertEquals("22", r.getRunwayWindshears().get(0));
  }
}
